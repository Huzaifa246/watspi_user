  ...
  return (
    <div className="Sidebar-Container">
      <div className="Sidebar-Comp-card">
        <Nav.Link href="/dashboard2" className={`mb-2 main-sidebar2 ${window.location.pathname === '/dashboard2' ? 'active-link' : ''}`}>
          <div className="Svg-Container svg-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" height="4vh">
        ...
        <Nav.Link href="/instances2" className={`mb-2 main-sidebar2 ${window.location.pathname === '/instances2' ? 'active-link' : ''}`}>
          <div className="Svg-Container svg-white">
